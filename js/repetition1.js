...
function validation(){
	...
	/** Option 2  => 4**/
	if( $('input[name=option2]:checked', '#testForm').val() != 4){
		contador = contador-1;
	...
	/** Option 4  => 3**/
	if( $('input[name=option4]:checked', '#testForm').val() != 3){
		contador = contador-1;
	...
	/** Option 5  => 4**/
	if( $('input[name=option5]:checked', '#testForm').val() != 4){
		contador = contador-1;
	...
	/** Option 6  => 2**/
	if( $('input[name=option6]:checked', '#testForm').val() != 2){
		contador = contador-1;
	...
	/** Option 9  => 4**/
	if( $('input[name=option9]:checked', '#testForm').val() != 4){
		contador = contador-1;
